...
* dm_top5_category_per_month - подсчитывает топ-5 product category за год-месяц, которые больше всего пользуются популярностью у пользователей (больше всего заказов в рамках год-месяц)
